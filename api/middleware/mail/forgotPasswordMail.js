const forgotPasswordMail = (req, link) => {
    ...
    const msg = {
        ...
        html: `<strong>Please click the link below to reset your password!</strong><br><br>Link expires in 48-hours<br><br>Link: ${process.env.NODE_HOST || process.env.PROD_HOST}/reset-password/${link}`,
    }
